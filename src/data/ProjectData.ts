...
const data: ProjectEntry[] = [
  {
    ...
    body: ` \
      ...
      <li><strong>Internal Development Team Launch:</strong> Prosci has since established its own internal development team, a testament to their growth and maturity.</li> \
