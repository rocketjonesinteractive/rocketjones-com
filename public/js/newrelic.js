...
NREUM.loader_config = {
  ...
  trustKey: '4111071',
  agentID: '1103276781',
  licenseKey: 'NRJS-94bb519d8d1754befac',
  applicationID: '1103276781',
};
NREUM.info = {
    ...
    r = {
        ...
        function c(e, t) {
          ...
          e &&
            ...
            Object.keys(a).forEach((e) => {
              void 0 === u[e] &&
                (a[e]?.forEach((t) => (0, i.p)('rumresp-' + e, [!1], void 0, t, r)), (u[e] = !1));
            }),
            s.add(t));
        }
        const u = {};
      ...
      1214: (e, t, r) => {
        ...
        function N(e) {
          ...
          return (
            !f.il || j[t.debugId]++ || ((j[t.debugId] = 1), c(t).inPlace(window.history, C, '-')), t
          );
        }
        var O = r(3239);
        const P = {},
                ...
                try {
                  ...
                  if (void 0 === e) e = r;
                    ...
                    if ((e = Array.isArray(e) && e.length ? e : [e]).some((e) => !r.includes(e)))
                      return (0, l.Z)(
                        'Invalid feature name supplied. Acceptable feature names are: '.concat(r),
                      );
  ...
  (i.m = r),
    ...
    (() => {
      ...
      var t = (t, r) => {
        ...
        r = (self['webpackChunk:NRBA-1.240.0.PROD'] = self['webpackChunk:NRBA-1.240.0.PROD'] || []);
    ...
    (() => {
      ...
      class N extends f {
        ...
        constructor(e, t) {
          ...
          super(e, t, C.t, r),
            l.il &&
              ((0, S.N)(() => (0, _.p)('docHidden', [(0, j.z)()], void 0, C.t, this.ee), !0),
              (0, D.bP)('pagehide', () =>
        ...
        constructor(e, t) {
          ...
          this.ee.on('fn-err', (e, t, n) => {
            this.abortHandler &&
              !this.#e.has(n) &&
              (this.#e.add(n),
              (0, _.p)('err', [this.#t(n), (0, j.z)()], void 0, r.D.jserrors, this.ee));
          }),
            this.ee.on('internal-error', (e) => {
              this.abortHandler &&
                (0, _.p)('ierr', [this.#t(e), (0, j.z)(), !0], void 0, r.D.jserrors, this.ee);
            }),
              ...
              (e) => {
                this.abortHandler &&
                  (this.#e.has(e.error)
                    ...
                    : (0, _.p)('err', [this.#n(e), (0, j.z)()], void 0, r.D.jserrors, this.ee));
              },
              (0, D.m$)(!1, this.removeOnAbort?.signal),
            ),
      ...
      class Q extends f {
        ...
        constructor(e, t) {
          ...
          if ((super(e, t, V.t, i), (0, n.OP)(e).xhrWrappable)) {
            (this.dt = new Z(e)), (this.handler = (e, t, r, n) => (0, _.p)(e, t, r, n, this.ee));
            try {
            ...
            (0, F.u5)(this.ee),
              ...
              (function (e, t, i, o) {
                ...
                function b(e, r) {
                  this.xhrCbStart &&
                    t.emit('xhr-cb-time', [(0, j.z)() - this.xhrCbStart, this.onload, r], r);
                }
                function y(e) {
                  var t,
                    r = e[1] || {};
